...
export class TimeoutComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public updateTimeout(data: any) {
    ...
    if (!newTimeout) return; // 💥 Ngăn lỗi nếu timeoutState chưa sẵn sàng
  
    // So sánh và cập nhật trạng thái timeout
    ...
    this.timeLeft = newTimeout.timeRemaining || this.timeLeft;
